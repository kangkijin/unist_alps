...
function headerStyle(){
	...
	if (windowWidth < 1280) {
		$('.mainau_wrap').insertAfter('.mainmyinfo_wrap ');
	}else {
		$('.mainau_wrap').insertAfter('.maingrade_wrap');
	}
...
function swiperSlide4() {
	var swiper = new Swiper('.main_notice .swiper-container', {
		slidesPerView: 1, 
		spaceBetween: 20,
		loop: false,
		loopFillGroupWithBlank: true,
		navigation: {
			nextEl: '.main_notice .arrow_right',
			prevEl: '.main_notice .arrow_left',
		}
	});
}
...
function swiperSlide5() {
	var swiper = new Swiper('.main_alps .swiper-container', {
		slidesPerView: 1, 
		spaceBetween: 20,
		loop: false,
		loopFillGroupWithBlank: true,
		navigation: {
			nextEl: '.main_alps .arrow_right',
			prevEl: '.main_alps .arrow_left',
		}
	});
}
...
function swiperSlide6() {
	var swiper = new Swiper('.main_faq .swiper-container', {
		slidesPerView: 1, 
		spaceBetween: 20,
		loop: false,
		loopFillGroupWithBlank: true,
		navigation: {
			nextEl: '.main_faq .arrow_right',
			prevEl: '.main_faq .arrow_left',
		}
	});
}
